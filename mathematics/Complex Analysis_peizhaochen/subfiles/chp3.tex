...
\begin{theorem}[\emph{Cauchy-Goursat}]
...
\begin{theorem}[多连同区域的\emph{Cauchy}积分公式]  略.
\end{theorem}
...
\end{theorem}
\begin{theorem}[\emph{Newton-Leibniz}]
...
\begin{theorem}[\emph{Liouville}定理]
	有界整函数必为常数
\end{theorem}
\begin{proof}
